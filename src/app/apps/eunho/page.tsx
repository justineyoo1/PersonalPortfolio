...
export default function EunhoLandingPage() {
  return (
    ...
    >
        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="flex items-end justify-between gap-6 flex-wrap">
            <div>
              ...
              >
                Two ways to keep it<span className="dot-cyan">.</span>
              </h2>
            </div>
            <p className="text-[#8B8B8B] text-[12px] max-w-xs">
              Auto-renews at $19.99/year until canceled. Cancel anytime in
              Settings.
            </p>
          </div>
          ...
          <div className="mt-8 grid md:grid-cols-2 gap-5">
            {/* Monthly */}
            <div className="card-premium rounded-2xl border hair bg-[#0E0E0E] p-6 flex items-center justify-between gap-6">
              <div>
                <p className="eyebrow text-[#8B8B8B]">Monthly</p>
                <p
                  className="font-serif font-medium text-[#F5F5F5] mt-1 leading-none"
                  style={{ fontSize: "40px" }}
                >
                  $3.99<span className="dot-cyan">.</span>
                </p>
                <p className="text-[#8B8B8B] text-[11.5px] mt-1.5">
                  Single-habit ritual. Widgets. History.
                </p>
              </div>
              <a
                href="https://apps.apple.com/app/id6761335497"
                target="_blank"
                rel="noopener noreferrer"
                className="shrink-0 pill-cta inline-flex items-center justify-center rounded-full border hair-strong h-10 px-5 text-[12px] font-medium tracking-wide text-[#F5F5F5]"
              >
                Start
              </a>
            </div>
            ...
            {/* Annual */}
            <div
              className="card-premium rounded-2xl border bg-[#0E0E0E] p-6 flex items-center justify-between gap-6 relative"
            ...
            >
              <div>
                ...
                <p className="text-[#8B8B8B] text-[11.5px] mt-1.5">
                  Insights. Streak freeze. Retroactive check-ins.
                </p>
              </div>
              <a
                href="https://apps.apple.com/app/id6761335497"
                target="_blank"
                rel="noopener noreferrer"
                className="shrink-0 inline-flex items-center justify-center rounded-full h-10 px-5 text-[12px] font-medium tracking-wide text-white"
      ...
      {/* FOOTER */}
      <footer className="relative border-t hair py-8">
        <div className="max-w-6xl mx-auto px-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-5">
            <a href="/apps/eunho/privacy" className="footlink">
              Privacy
            </a>
            <span className="chip-sep">·</span>
            <a href="/apps/eunho/terms" className="footlink">
              Terms
            </a>
            <span className="chip-sep">·</span>
            <a href="mailto:justineyoo2005@gmail.com" className="footlink">
              Support
            </a>
          </div>

          <p className="text-[11px] text-[#8B8B8B]">© 2026 Justin Yoo.</p>
        </div>
      </footer>
    </div>
  );
